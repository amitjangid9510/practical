  ...
  try {
    ...
    users.forEach((u, i) => {
      console.log(`User[${i}]:`, {
        ...
        usernameMatch: u.username.trim().toLowerCase() === inputUsername,
        passwordMatch: u.password === hashedInputPassword
      });
    });
    ...
    <div className="min-h-screen flex items-center justify-center md:p-4 relative overflow-hidden sm:min-h-[calc(100vh-72px)]">
      ...
      >
        <div className="bg-white/10 rounded-xl shadow-2xl border-2 border-white/20 overflow-hidden backdrop-blur-lg">
              ...
              >
                ...
                >
                  {isSubmitting ? (
                    ...
                    <>
                      SIGN IN <FiArrowRight className="ml-2 sm:ml-3 text-lg sm:text-xl" />
                    </>
                  )}
                </motion.button>
              </motion.div>
          ...
          <div className="px-4 sm:px-6 py-3 sm:py-4 bg-white/5 border-t border-white/20 text-center">
            <motion.div 
