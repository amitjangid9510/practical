        ...
        <div className="bg-white/10 rounded-xl shadow-2xl border-2 border-white/20 overflow-hidden backdrop-blur-lg">
          ...
          <div className="p-4 sm:p-6 md:p-8">
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-4 sm:space-y-6" noValidate>
              ...
              >
                <label className="block text-base sm:text-lg font-bold text-white uppercase tracking-wider mb-1 sm:mb-2">USERNAME</label>
                <div className="relative">
                  ...
                  <input
                    ...
                    className={`w-full pl-10 sm:pl-12 pr-3 sm:pr-4 py-2 sm:py-3 text-base sm:text-lg text-white bg-white/5 rounded-lg sm:rounded-xl border-2 ${errors.username ? 'border-white/50 focus:border-white' : 'border-white/20 focus:border-white'} focus:ring-2 focus:ring-white/30 placeholder-white/50 font-medium transition-all`}
                  />
                </div>
                <AnimatePresence>
                  {errors.username && (
                    ...
                    >
                      <svg className="w-4 h-4 sm:w-5 sm:h-5 mr-1 sm:mr-1.5 mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 8v4m0 4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                      </svg>
              ...
              >
                <label className="block text-base sm:text-lg font-bold text-white uppercase tracking-wider mb-1 sm:mb-2">EMAIL</label>
                <div className="relative">
                  <div className="absolute inset-y-0 left-0 pl-3 sm:pl-4 flex items-center pointer-events-none">
                  ...
                  <input
                    ...
                    className={`w-full pl-10 sm:pl-12 pr-3 sm:pr-4 py-2 sm:py-3 text-base sm:text-lg text-white bg-white/5 rounded-lg sm:rounded-xl border-2 ${errors.email ? 'border-white/50 focus:border-white' : 'border-white/20 focus:border-white'} focus:ring-2 focus:ring-white/30 placeholder-white/50 font-medium transition-all`}
                  />
                </div>
                <AnimatePresence>
                  {errors.email && (
              ...
              >
                <label className="block text-base sm:text-lg font-bold text-white uppercase tracking-wider mb-1 sm:mb-2">PASSWORD</label>
                <div className="relative">
                  <div className="absolute inset-y-0 left-0 pl-3 sm:pl-4 flex items-center pointer-events-none">
                  ...
                  <input
                    ...
                    className={`w-full pl-10 sm:pl-12 pr-3 sm:pr-4 py-2 sm:py-3 text-base sm:text-lg text-white bg-white/5 rounded-lg sm:rounded-xl border-2 ${errors.password ? 'border-white/50 focus:border-white' : 'border-white/20 focus:border-white'} focus:ring-2 focus:ring-white/30 placeholder-white/50 font-medium transition-all`}
                  />
                </div>
                <AnimatePresence>
                  {errors.password && (
              ...
              >
                <label className="block text-base sm:text-lg font-bold text-white uppercase tracking-wider mb-1 sm:mb-2">CONFIRM PASSWORD</label>
                <div className="relative">
                  <div className="absolute inset-y-0 left-0 pl-3 sm:pl-4 flex items-center pointer-events-none">
                    <FiLock className="text-black text-lg sm:text-xl" />
                  </div>
                  <input
                    ...
                    className={`w-full pl-10 sm:pl-12 pr-3 sm:pr-4 py-2 sm:py-3 text-base sm:text-lg text-white bg-white/5 rounded-lg sm:rounded-xl border-2 ${errors.confirmPassword ? 'border-white/50 focus:border-white' : 'border-white/20 focus:border-white'} focus:ring-2 focus:ring-white/30 placeholder-white/50 font-medium transition-all`}
                  />
                </div>
                <AnimatePresence>
              ...
              >
                <motion.button
                  ...
                  className={`w-full flex justify-center items-center py-2 sm:py-3 px-4 sm:px-6 rounded-lg sm:rounded-xl text-lg sm:text-xl font-bold text-white bg-white/10 border-2 border-white/20 hover:bg-white/20 hover:border-white/30 focus:outline-none focus:ring-4 focus:ring-white/30 transition-all ${isSubmitting ? 'opacity-80' : ''}`}
                  whileTap={{ scale: 0.98 }}
                >
                  {isSubmitting ? (
                    ...
                    <>
                      SIGN UP <FiArrowRight className="ml-2 sm:ml-3 text-lg sm:text-xl" />
                    </>
                  )}
                </motion.button>
              </motion.div>
